...
$(window).scroll(function(){
	...
	$(".menu-mobile li:not('.menu-mobile__haschild') > a").click(function() {
		...
		$(".menu-mobile__haschild a").click(function(e) {
			e.preventDefault();
			$(this).siblings(".mobile-dropdown").slideToggle(400);
		});
...
$('.btn-tab').click(function(event) {
	...
	$(".btn-tab:not('.show-mobile')").click(function(event) {
		$(".btn-tab:not('.show-mobile')").removeClass('active');
...
$('.btn-tab.show-mobile').click(function(event) {
		event.preventDefault();
